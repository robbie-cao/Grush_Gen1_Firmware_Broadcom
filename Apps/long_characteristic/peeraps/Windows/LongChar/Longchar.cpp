...
// LongChar.cpp : Defines the class behaviors for the application.
//
#include "stdafx.h"
#include "btwleapis.h"
#include "LongChar.h"
...
GUID guidSvcLongChar; 
GUID guidCharLongChar;

// CLongCharApp

BEGIN_MESSAGE_MAP(CLongCharApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CLongCharApp construction

CLongCharApp::CLongCharApp()
{
}


// The one and only CLongCharApp object
...
BOOL CLongCharApp::InitInstance()
{
	...
	if (IsOSWin8())
	{
        ...
        guidSvcLongChar = GUID_LONG_CHAR_SERVICE;
        guidCharLongChar = GUID_LONG_CHAR_CHAR;
	}
	else if (IsOSWin7())
	{
		dlg.m_bWin8 = FALSE;
		...
		{
			MessageBox(NULL, L"Failed to load WICEDLeApi.Dll", L"Error", MB_OK);
			return FALSE;
		}
        ...
        BtwGuidFromGuid(&guidSvcLongChar, &GUID_LONG_CHAR_SERVICE);
        BtwGuidFromGuid(&guidCharLongChar, &GUID_LONG_CHAR_CHAR);
    }
	else
	{
