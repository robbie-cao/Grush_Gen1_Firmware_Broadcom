...
/** @file
*
* GATT Client for Watch application 
*
* If GATT server contains Update DB characteristic record register for notification
*
*/
...
// send it out
//
void gatt_client_encryption_changed(HCI_EVT_HDR *evt)
{
