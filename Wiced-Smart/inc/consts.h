...
#define FM_STACK_SIZE               92
#else
#define FM_STACK_SIZE               (512/4)
#endif
...
#else
#ifndef USE_CALL_STACK_FOR_SHA1
#define LM_STACK_SIZE (160 + 80) /* need to fine tune this value later */
#else
// TODO: Optimize and add 320 bytes only if sha1 is in the critical path of LM.
#define LM_STACK_SIZE (160 + 80 + 80)
#endif
#endif
