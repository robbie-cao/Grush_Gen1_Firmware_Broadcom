...
/* BRCM: We don't have stdio */
/* BRCM: #include <stdio.h>  */
#include <string.h>

/* BRCM: Add custom types    */
#include "types.h"


/* BRCM: #include "config.h" */

/* BRCM: We need big num and prime number generation code.  */
#define POLARSSL_BIGNUM_C

/*
BRCM: These types are already defined by types.h
#ifdef _MSC_VER
#include <basetsd.h>
#if (_MSC_VER <= 1200)
